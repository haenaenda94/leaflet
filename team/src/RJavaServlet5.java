...
public class RJavaServlet5 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("leaflet1")) {
			...
			request.setAttribute("leafletChartName", "http://localhost:8081/team/leafletchart1/"+result);	
			...
			request.setAttribute("leafletChartName", "http://localhost:8081/team/leafletchart2/"+result);	
			...
			request.setAttribute("leafletChartName", "http://localhost:8081/team/leafletchart3/"+result);	
