...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	if(request.getParameter("booktitle")!=null) {
		file=request.getParameter("javaresult")+".jsp";
	}
	...
	try {
		...
		REXP x=conn.eval("imsi<-source('C:/Users/haena/Desktop/project/songpa.R',encoding='UTF-8'); imsi$value");
		RList list = x.asList();
		...
		REXP x2=conn.eval("imsi2<-source('C:/Users/haena/Desktop/project/seongbuk.R',encoding='UTF-8'); imsi2$value");
		...
		*/
		...
		list_book.add(s);
		list_book.add(s2);
		int v_list_size = list_book.size();
		String[][] temp=null;	
